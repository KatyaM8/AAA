...
int main(int, char**)
{
    igl::readOBJ("../my_sources/objects/cheekbones1.obj", v_cheekbones, f_cheekbones);
    igl::readOBJ("../my_sources/objects/chin1.obj", v_chin, f_chin);
    igl::readOBJ("../my_sources/objects/horns1.obj", v_horns, f_horns);
    igl::readOBJ("../my_sources/objects/lips1.obj", v_lips, f_lips);
    igl::readOBJ("../my_sources/objects/nose1.obj", v_nose, f_nose);
    igl::readOBJ("../my_sources/objects/cheek1.obj", v_cheek, f_cheek);
...
// Изменить цвет окна на красный
        ...
        //ImGui::SliderInt("My Slider", &value, 0, 100);


        //Morph::nose(viewer, value);
        //if (value != 50){
            //std::cout<<"hey";
        //}
        //ImGui::SameLine();
